...
/* package haskell-scotty-app-0.1.0.0 */
#ifndef VERSION_haskell_scotty_app
#define VERSION_haskell_scotty_app "0.1.0.0"
#endif /* VERSION_haskell_scotty_app */
#ifndef MIN_VERSION_haskell_scotty_app
#define MIN_VERSION_haskell_scotty_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_scotty_app */
...
/* package html-conduit-1.3.2.2 */
#ifndef VERSION_html_conduit
#define VERSION_html_conduit "1.3.2.2"
#endif /* VERSION_html_conduit */
#ifndef MIN_VERSION_html_conduit
...
/* package xml-conduit-1.10.1.0 */
#ifndef VERSION_xml_conduit
#define VERSION_xml_conduit "1.10.1.0"
...
#define CURRENT_COMPONENT_ID "haskell-scotty-app-0.1.0.0-inplace-haskell-scotty-app-test"
